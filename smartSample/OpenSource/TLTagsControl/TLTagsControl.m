...
- (void)commonInit {
    ...
    tagInputField_.font = [UIFont fontWithName:@"GothamRounded-Medium" size:18];
    tagInputField_.placeholder = @"";
     tagInputField_.textColor = [UIColor colorWithRed:(103.0f/255.0f) green:(205.0f/255.0f) blue:(236.0f/255.0f) alpha:1.0];
...
- (void)deleteTagButton:(UIButton *)sender {
    ...
    NSInteger index = [tagSubviews_ indexOfObject:view];
    [self.tapDelegate removedTag:_tags [index]];
...
- (void) deleteTag: (NSString *) string
{
    ...
    {
       if([_tags [i] isEqualToString:string])
       {
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    [tapDelegate textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacedString:(NSString *)string];
